...
@Component({
  selector: 'real-estate-two-template',
  templateUrl: './real-estate-two-template.component.html',
  styleUrls: ['./real-estate-two-template.component.css']
})
export class RealEstateTwoTemplateComponent implements OnInit{
