...
export class RestaurantTemplateComponent implements OnInit{
  ...
  constructor(
    ...
    ngOnInit(): void {
      ...
      if (this.details.template_values) {
        ...
        this.campaignService.restaurant_values = parseValues; 
      }else if (this.details.default_values){
        this.campaignService.restaurant_values = this.details.default_values;
      }
  ...
  updateTemplateDetails(){
    ...
    let data = {
      ...
      template_values : JSON.stringify(this.campaignService.restaurant_values)
    }
  ...
  pdfDownload() {
    ...
    html2canvas(val, { logging: true, letterRendering: 1, allowTaint: false, useCORS: true }).then(canvas => {
  ...
  getTargetValue(target){
    ...
    if (target_array.length === 1) {
      value = this.campaignService.restaurant_values[target_array[0]];
    } else if (target_array.length === 2) {
      value = this.campaignService.restaurant_values[target_array[0]][target_array[1]];
    } else if(target_array.length === 3) {
      value = this.campaignService.restaurant_values[target_array[0]][target_array[1]][target_array[2]];
    } else if(target_array.length === 4){
      value = this.campaignService.restaurant_values[target_array[0]][target_array[1]][target_array[2]][target_array[3]];
    } else if(target_array.length === 5){
      value = this.campaignService.restaurant_values[target_array[0]][target_array[1]][target_array[2]][target_array[3]][target_array[4]];
    }
  ...
  openModal(template: TemplateRef<any>, target) {
