...
import { styles } from './app-squer.style';

@Component({
  selector: 'app-squer-cropper',
  templateUrl: './squer-crop.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  styleUrls: ['./squer-crop.component.css']
})

export class SquerCropComponent implements OnInit {
