...
export class ProfileCropComponent implements OnInit {
  ...
  constructor(
    ...
    if (this.profile_media === undefined) {
      this.profile_media = {}
    }
    this.getScreenSize();
  ...
  ngOnInit() {
    if (this.cover_type === 'logo_image') {
      this.myConfig.width = 350;
      this.myConfig.height = 100;
    }
  }
