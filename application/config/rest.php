...
$config['auth_override_class_method']['users']['check_pricing_plan_status'] = 'none';
$config['auth_override_class_method']['users']['email_and_phone_validate'] = 'none';
$config['auth_override_class_method']['users']['login'] = 'none';
$config['auth_override_class_method']['users']['verify'] = 'none';
$config['auth_override_class_method']['users']['forgot_password'] = 'none';
$config['auth_override_class_method']['users']['reset_password'] = 'none';
$config['auth_override_class_method']['users']['check_reset_password_code'] = 'none';
$config['auth_override_class_method']['users']['resend_account_verification'] = 'none';
...
|
 */
$config['rest_keys_table'] = 'user_login_sessions';
