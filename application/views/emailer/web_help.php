<?php $this->load->view('emailer/email-header');?>
    ...
    <p style="font-size:16px; color:#000000;">A query has been generated.</p>
    <p style="font-size:16px; color:#000000;">Name: <span style="color:#f61400;font-weight: 600;"><?php echo ucfirst(strtolower($name)); ?></span>,</p>
    <p style="font-size:16px; color:#000000;">Company: <span style="color:#f61400;font-weight: 600;"><?php echo $business_name; ?></span>,</p>
