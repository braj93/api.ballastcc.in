	...
	<div class="landing-template">
		<div class="header-banner">
			...
			<div class="top-content-bar">
				<h2 class="page-title"><?php echo $campaign['template_values']['header']['title']['value']; ?></h2>
			...
			<div class="about-us-content">
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="about-us-image-holder">
								<div class="about-us-image v-image-block">
		...
		<div class="products-block-section l-padding-md bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
					...
					<div class="col-sm-4">
						<div class="products-block">
							...
							<div class="product-title">
								<h3><?php echo  $campaign['template_values']['three_column_content_promo']['one']['title']['value']; ?></h3>
							</div>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="products-block">
							...
							<div class="product-title">
								<h3><?php echo  $campaign['template_values']['three_column_content_promo']['two']['title']['value']; ?></h3>
							</div>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="products-block">
							...
							<div class="product-title">
								<h3><?php echo  $campaign['template_values']['three_column_content_promo']['three']['title']['value']; ?></h3>
							</div>
						</div>
					</div>
				</div>
