...
.retail-template .products-block-section .products-block:before {
    opacity: 0.5;
}

.retail-template .products-block {
    transition:all 0.3s ease-in-out;
}
.retail-template .products-block {
    border-radius:5px;
...
.retail-template .products-block-section .col-sm-4:hover .products-block:before {
...
.retail-template .products-block:hover {
    transform:scale(1.03);
}
.retail-template .products-block:hover .landing-btn-sm {
    margin-bottom: 0;
    opacity:1;
    visibility:visible;
}
