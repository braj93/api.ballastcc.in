...
.banner-form .landing-input {
    background: transparent;
    border-color:#fff;
    color:#fff;
}

.banner-form .landing-input::placeholder { /* Chrome, Firefox, Opera, Safari 10.1+ */
  color: #fff;
  opacity:0.8;
}

.banner-form .landing-input:-ms-input-placeholder { /* Internet Explorer 10-11 */
  color: #fff;
  opacity:0.8;
}

.banner-form .landing-input::-ms-input-placeholder { /* Microsoft Edge */
  color: #fff;
  opacity:0.8;
}
...
.banner-form .landing--submit-btn {
    border-color:#fff;
    color: #fff;
    background: transparent;
}
