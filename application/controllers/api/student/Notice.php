...
class Notice extends REST_Controller
{
    ...
    {
        echo 'Get Rest Controller of Imp notice for student';
    }
    ...
    {
        $this->_response["service_name"] = "student/notice/imp_notice_list";
    ...
    {
        $this->_response["service_name"] = "student/notice/get_imp_notice_by_id";
