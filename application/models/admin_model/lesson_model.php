...
***
    */
    ...
    public function qa_list($user_id, $keyword = '', $limit = 0, $offset = 0, $column_name, $order_by, $user_type)
    {
        if ($limit > 0 && $offset >= 0) {
            $this->db->limit($limit, $offset);
...
***
    */
    ...
    public function list_by_lesson_id($user_id, $keyword = '', $limit = 0, $offset = 0, $column_name, $order_by, $user_type, $lesson_id)
    {
        // if ($limit > 0 && $offset >= 0) {
        //     $this->db->limit($limit, $offset);
